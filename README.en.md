...
A local-first workspace for turning Kindle highlights into searchable notes, flomo-ready text, and shareable image cards.
...
- Copies a selected highlight as a flomo-formatted memo.
...
- Copying for flomo writes to the local clipboard and never sends the memo automatically.
